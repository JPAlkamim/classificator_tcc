...
# Excluindo a classe 4
X3 = X3[y3 != 4]
y3 = y3[y3 != 4]

# Imprimindo o número de classes após excluir a classe 4
...
# Calcula a precisão para cada classe (exceto a classe 4)
...
# Calcula a revocação para cada classe (exceto a classe 4)
